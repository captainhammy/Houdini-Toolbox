...
class TestInlineCpp(object):
    ...
    def test_is_insideFail(self):
        ...
        assert not ht.inline.api.bounding_box_is_inside(bbox1, bbox2)
    ...
    def test_intersectsFail(self):
        ...
        assert not ht.inline.api.bounding_boxes_intersect(bbox1, bbox2)
    ...
    def test_compute_intersectionFail(self):
        ...
        assert not ht.inline.api.compute_bounding_box_intersection(bbox1, bbox2)
    ...
    def test_is_multiparm(self):
        ...
        assert ht.inline.api.is_parm_multiparm(parmTuple)
    ...
    def test_v3Project(self):
        ...
        assert proj.isAlmostEqual(result)
    ...
    def test_is_contained_by__true(self):
        ...
        assert ht.inline.api.node_is_contained_by(source_node, target_node)

    def test_is_contained_by__false(self):
        source_node = OBJ.node("test_is_contained_by/subnet/box")
        target_node = OBJ.node("test_is_contained_by/other_subnet")

        assert not ht.inline.api.node_is_contained_by(source_node, target_node)
