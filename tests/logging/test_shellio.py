...
class Test_PythonShellHandler(object):
    ...
    def test_emit__shellio(self, init_handler, mocker):
        ...
        mock_format = mocker.patch.object(ht.logging.shellio.PythonShellHandler, "format")
    ...
    def test_emit__generic_exception(self, init_handler, mocker):
        ...
        mock_handle = mocker.patch.object(ht.logging.shellio.PythonShellHandler, "handleError")
