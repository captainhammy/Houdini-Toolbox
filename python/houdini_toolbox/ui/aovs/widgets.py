...
from houdini_toolbox.ui.aovs import models, uidata, utils
...
class AOVSelectTreeWidget(
    ...
    def dropEvent(self, event):
        ...
        import houdini_toolbox.ui.aovs.dialogs
        ...
        for path in paths:
            ...
            for aov in aovs:
                houdini_toolbox.ui.aovs.dialogs.create_new_aov(aov)
    ...
    def edit_selected_aovs(self):
        ...
        for aov in aovs:
            dialog = houdini_toolbox.ui.aovs.dialogs.EditAOVDialog(aov, parent)
    ...
    def edit_selected_groups(self):
        ...
        for group in groups:
            dialog = houdini_toolbox.ui.aovs.dialogs.EditGroupDialog(group, parent)
    ...
    def show_aov_info(self):
        ...
        for aov in aovs:
            info_dialog = houdini_toolbox.ui.aovs.dialogs.AOVInfoDialog(aov, parent)
...
class AvailableAOVsToolBar(AOVViewerToolBar):
    ...
    def __init__(self, parent=None):
        ...
        new_aov_action = QtWidgets.QAction(
            QtGui.QIcon(":houdini_toolbox/rsc/icons/aovs/create_aov.png"),
            "Create a new AOV.",
            self,
            triggered=houdini_toolbox.ui.aovs.dialogs.create_new_aov,
        )
        ...
        edit_aov_action = QtWidgets.QAction(
            QtGui.QIcon(":houdini_toolbox/rsc/icons/aovs/edit_aov.png"),
            "Edit AOV.",
            self,
        ...
        new_group_action = QtWidgets.QAction(
            QtGui.QIcon(":houdini_toolbox/rsc/icons/aovs/create_group.png"),
        ...
        edit_group_action = QtWidgets.QAction(
            QtGui.QIcon(":houdini_toolbox/rsc/icons/aovs/edit_group.png"),
            "Edit an AOV group.",
            self,
...
class AOVSelectWidget(QtWidgets.QWidget):
    ...
    def create_group(self):
        ...
        houdini_toolbox.ui.aovs.dialogs.create_new_group(aovs)
