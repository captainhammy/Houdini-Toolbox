...
def filterFog():
    ...
    """
    logger.debug("filterFog ({0})".format(mantra.property("object:name")[0]))
...
def filterInstance():
    ...
    """
    logger.debug("filterInstance ({0})".format(mantra.property("object:name")[0]))
...
def filterLight():
    ...
    """
    logger.debug("filterLight ({0})".format(mantra.property("object:name")[0]))
...
def filterPlane():
    ...
    if variable == channel or channel == "":
        logger.debug("filterPlane ({0})".format(variable))
    else:
        logger.debug("filterPlane ({0} -> {1})".format(variable, channel))
